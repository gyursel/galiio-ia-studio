...
/* hero parallax */
  ...
  return (
    ...
    >
      {/* ════════ STYLES ════════ */}
      <style>{`
        @import url('https://fonts.googleapis.com/css2?family=Cormorant+Garamond:ital,wght@0,300;0,400;0,600;1,300;1,400&family=DM+Mono:wght@300;400;500&family=Outfit:wght@200;300;400&display=swap');
        ...
        .vpr-site {
          ...
          --vpr-surface2:  #131118;
          --vpr-surface3:  #1A1822;
          --vpr-glass:     rgba(255,255,255,0.03);
          --vpr-line:      rgba(255,255,255,0.065);
          --vpr-line2:     rgba(255,255,255,0.13);
          --vpr-line3:     rgba(255,255,255,0.22);
          --vpr-text:      #EDE9E1;
          --vpr-text-muted: rgba(237,233,225,0.50);
          --vpr-text-sub:  rgba(237,233,225,0.24);
          --vpr-mono:      'DM Mono','Courier New',monospace;
          --vpr-serif:     'Cormorant Garamond','Times New Roman',serif;
          --vpr-sans:      'Outfit',system-ui,sans-serif;
        ...
        .vpr-site::before {
          content: '';
          position: fixed; inset: 0; opacity: 0.028; pointer-events: none; z-index: 9999;
        ...
        * { box-sizing:border-box; margin:0; padding:0; }
        ...
        .vpr-progress-fill {
          height: 100%;
          background: linear-gradient(90deg, var(--vpr-accent), color-mix(in srgb, var(--vpr-accent) 60%, #fff));
        ...
        .vpr-ambient {
          ...
          background: radial-gradient(circle, color-mix(in srgb, var(--vpr-accent) 7%, transparent), transparent 70%);
          pointer-events: none; z-index: 0; top: -240px; right: -140px;
          animation: ambientDrift 22s ease-in-out infinite alternate;
        }
        .vpr-ambient-2 {
          position: fixed; width: 500px; height: 500px; border-radius: 50%;
          background: radial-gradient(circle, color-mix(in srgb, var(--vpr-accent) 4%, transparent), transparent 70%);
          pointer-events: none; z-index: 0; bottom: -200px; left: -100px;
        ...
        .vpr-nav {
          ...
          padding: 0 64px 0 72px; height: 72px;
        ...
        .vpr-logo-block { display:flex; align-items:baseline; gap:14px; }
        .vpr-logo-name {
          font-family: var(--vpr-serif); font-size:22px; font-weight:300;
          letter-spacing:0.30em; text-transform:uppercase; color:var(--vpr-text);
        }
        .vpr-logo-rule { width:1px; height:18px; background:var(--vpr-line2); display:inline-block; vertical-align:middle; }
        .vpr-logo-sub { font-size:9px; letter-spacing:0.22em; text-transform:uppercase; color:var(--vpr-text-sub); }
        .vpr-nav-links { display:flex; gap:36px; align-items:center; }
        .vpr-nav-links a {
        ...
        .vpr-nav-links a::after {
          ...
          width:0; height:1px; background:var(--vpr-accent); transition:width 0.3s var(--vpr-ease);
        }
        ...
        .vpr-nav-cta {
          ...
          border:1px solid color-mix(in srgb, var(--vpr-accent) 55%, transparent);
          padding:9px 20px;
          transition:background 0.25s, color 0.25s, border-color 0.25s, box-shadow 0.25s;
        }
        .vpr-nav-cta:hover {
          background:var(--vpr-accent); color:#fff; border-color:var(--vpr-accent);
          box-shadow:0 0 28px color-mix(in srgb, var(--vpr-accent) 30%, transparent);
        }
        ...
        .vpr-drawer a {
          font-family:var(--vpr-serif); font-size:42px; font-weight:300;
          letter-spacing:0.06em; color:var(--vpr-text-muted);
          transition:color 0.2s, letter-spacing 0.3s var(--vpr-ease);
        }
        .vpr-drawer a:hover { color:var(--vpr-text); letter-spacing:0.12em; }
        ...
        @keyframes heroMediaIn {
          from { transform:scale(1.10); filter:brightness(0.05) saturate(0); }
          to   { transform:scale(1.04); filter:brightness(0.22) saturate(0.45); }
        }
        .vpr-hero-media-fallback {
          width:100%; height:100%;
          background:
            radial-gradient(ellipse 55% 45% at 70% 38%, color-mix(in srgb, var(--vpr-accent) 16%, transparent), transparent),
            linear-gradient(155deg, #100E18 0%, #07060A 55%, #120B10 100%);
        }
        .vpr-hero-overlay {
          position:absolute; inset:0;
          background:
            linear-gradient(92deg, rgba(7,6,10,0.97) 0%, rgba(7,6,10,0.65) 52%, rgba(7,6,10,0.92) 100%),
            linear-gradient(180deg, rgba(7,6,10,0.1) 0%, rgba(7,6,10,0.7) 100%);
        }
        /* Accent slash */
        .vpr-hero-slash {
          position:absolute; right:360px; top:0; bottom:0; width:1px;
          background:linear-gradient(to bottom, transparent, var(--vpr-line2) 30%, var(--vpr-line2) 70%, transparent);
          z-index:1;
        }
        .vpr-hero-copy {
        ...
        .vpr-hero-eyebrow {
          ...
          color:var(--vpr-accent); margin-bottom:32px;
          display:flex; align-items:center; gap:16px;
          opacity:0; animation:fadeUp 0.9s 0.3s var(--vpr-ease) forwards;
        }
        .vpr-hero-eyebrow::before {
          content:''; display:block; width:0; height:1px; background:var(--vpr-accent);
        ...
        .vpr-hero-h1 {
          ...
          font-weight:300; line-height:0.91; letter-spacing:-0.015em;
          color:var(--vpr-text); margin-bottom:38px;
          white-space:pre-line;
          opacity:0; animation:fadeUp 1s 0.5s var(--vpr-ease) forwards;
        }
        .vpr-hero-h1 em { font-style:italic; color:var(--vpr-text-muted); }
        .vpr-hero-sub {
          font-size:12px; line-height:1.9; color:var(--vpr-text-muted);
          max-width:440px; margin-bottom:56px; letter-spacing:0.05em;
        ...
        .vpr-stat-num {
          font-family:var(--vpr-serif); font-size:48px; font-weight:300;
        ...
        .vpr-stat-bar {
          width:20px; height:1px; background:var(--vpr-accent);
          transition:width 0.55s var(--vpr-ease);
        }
        .vpr-stat-row--visible .vpr-stat-bar { width:32px; }
        ...
        /* ── BUTTONS ── */
        .vpr-btn-primary {
          font-family:var(--vpr-mono); font-size:10px; letter-spacing:0.22em;
          text-transform:uppercase;
          background:var(--vpr-accent); color:#fff;
          padding:15px 36px; position:relative; overflow:hidden;
        ...
        .vpr-btn-primary::after {
          ...
          height:100%; background:rgba(0,0,0,0.12);
          transform:translateY(100%); transition:transform 0.3s var(--vpr-ease);
        }
        .vpr-btn-primary:hover {
          box-shadow:0 10px 40px color-mix(in srgb, var(--vpr-accent) 40%, transparent);
        ...
        .vpr-marquee-sep { color:var(--vpr-accent); font-size:6px; }
 
        /* ── SECTION LABEL ── */
        .vpr-section-label {
          font-size:9px; letter-spacing:0.32em; text-transform:uppercase;
          color:var(--vpr-accent); display:flex; align-items:center; gap:14px;
        }
        .vpr-section-label::before { content:''; width:26px; height:1px; background:var(--vpr-accent); }
 
        /* ── FEATURES STRIP ── */
        .vpr-strip-section { padding:0 64px 0 72px; border-top:1px solid var(--vpr-line); }
        .vpr-strip-header {
          padding:80px 0 0; display:flex; align-items:flex-end;
          justify-content:space-between; margin-bottom:0;
        }
        .vpr-section-title {
          font-family:var(--vpr-serif); font-size:clamp(32px,4vw,54px);
          font-weight:300; line-height:1.1; letter-spacing:-0.01em; max-width:560px;
        }
        .vpr-strip-grid {
        ...
        .vpr-strip-card {
          padding:48px 36px; border-right:1px solid var(--vpr-line);
        ...
        .vpr-strip-card::before {
          ...
          background:linear-gradient(to top, color-mix(in srgb, var(--vpr-accent) 7%, transparent), transparent);
        ...
        .vpr-strip-index { font-size:9px; letter-spacing:0.18em; color:var(--vpr-text-sub); margin-bottom:36px; }
        .vpr-strip-card-accent {
          width:28px; height:2px; background:var(--vpr-accent); margin-bottom:24px;
          transition:width 0.45s var(--vpr-ease);
        }
        .vpr-strip-card:hover .vpr-strip-card-accent { width:56px; }
        .vpr-strip-card h3 {
          font-family:var(--vpr-serif); font-size:22px; font-weight:400;
          line-height:1.2; margin-bottom:14px; color:var(--vpr-text);
        }
        .vpr-strip-card p { font-size:11px; line-height:1.9; color:var(--vpr-text-muted); letter-spacing:0.04em; }
        ...
        .vpr-mosaic-cell { background:var(--vpr-surface); overflow:hidden; position:relative; }
        .vpr-mosaic-cell img {
          filter:saturate(0.4) brightness(0.6);
          transition:filter 0.7s var(--vpr-ease), transform 0.7s var(--vpr-ease);
        }
        .vpr-mosaic-cell:hover img { filter:saturate(0.9) brightness(0.88); transform:scale(1.05); }
        .vpr-mosaic-cell-a { grid-column:1/3; grid-row:1; }
        .vpr-mosaic-cell-b {
          grid-column:3; grid-row:1;
          display:flex; flex-direction:column; justify-content:flex-end;
          padding:48px; background:var(--vpr-surface2);
        }
        ...
        .vpr-mosaic-cell-b .vpr-mosaic-text h2 {
          font-family:var(--vpr-serif); font-size:30px; font-weight:300;
          line-height:1.2; color:var(--vpr-text); margin-bottom:18px;
        }
        .vpr-mosaic-cell-b .vpr-mosaic-text span {
          font-size:11px; line-height:1.8; color:var(--vpr-text-muted); letter-spacing:0.04em;
        }
        .vpr-mosaic-cell-c { grid-column:1; grid-row:2; }
        .vpr-mosaic-cell-d {
          grid-column:2; grid-row:2;
          display:flex; flex-direction:column; justify-content:center; padding:56px;
          background:color-mix(in srgb, var(--vpr-accent) 11%, var(--vpr-surface));
          border:1px solid color-mix(in srgb, var(--vpr-accent) 26%, transparent);
          position:relative; overflow:hidden;
        }
        .vpr-mosaic-cell-d::before {
          content:'"'; position:absolute; top:-28px; left:32px;
          font-family:var(--vpr-serif); font-size:200px; font-weight:300;
          color:color-mix(in srgb, var(--vpr-accent) 12%, transparent);
          line-height:1; pointer-events:none;
        }
        .vpr-mosaic-cell-d blockquote {
          font-family:var(--vpr-serif); font-size:23px; font-style:italic;
          font-weight:300; line-height:1.55; color:var(--vpr-text);
        ...
        .vpr-mosaic-img-overlay {
          position:absolute; inset:0;
          background:linear-gradient(to top, rgba(7,6,10,0.82), transparent 60%);
        }
        .vpr-mosaic-img-tag {
        ...
        .vpr-mosaic-img-tag::before { content:''; width:16px; height:1px; background:var(--vpr-accent); }
        ...
        .vpr-editorial-intro h2 {
          font-family:var(--vpr-serif); font-size:40px; font-weight:300;
          line-height:1.15; margin-bottom:24px; color:var(--vpr-text);
        }
        .vpr-editorial-intro p { font-size:11px; line-height:1.9; color:var(--vpr-text-muted); letter-spacing:0.04em; }
        ...
        .vpr-timeline-index {
          font-size:9px; letter-spacing:0.22em; color:var(--vpr-text-sub); padding-top:6px; position:relative;
        }
        ...
        .vpr-timeline-body h3 {
          font-family:var(--vpr-serif); font-size:30px; font-weight:400;
          line-height:1.15; margin-bottom:16px; color:var(--vpr-text); transition:color 0.25s;
        }
        .vpr-timeline-item:hover .vpr-timeline-body h3 { color:color-mix(in srgb, var(--vpr-accent) 75%, var(--vpr-text)); }
        .vpr-timeline-body p { font-size:11px; line-height:1.9; color:var(--vpr-text-muted); margin-bottom:22px; letter-spacing:0.04em; }
        ...
        .vpr-gallery-card:hover img { filter:saturate(0.82) brightness(0.9); transform:scale(1.06); }
        .vpr-gallery-caption {
          position:absolute; bottom:0; left:0; right:0; padding:44px 24px 24px;
          background:linear-gradient(to top, rgba(7,6,10,0.94), transparent);
        ...
        .vpr-gallery-caption strong { font-family:var(--vpr-serif); font-size:20px; font-weight:400; color:var(--vpr-text); }
        ...
        .vpr-quote-mark {
          font-family:var(--vpr-serif); font-size:120px; font-weight:300; line-height:0;
          color:color-mix(in srgb, var(--vpr-accent) 30%, transparent);
          display:block; margin-bottom:-20px;
        }
        .vpr-testimonial-quote {
          font-family:var(--vpr-serif); font-size:clamp(24px,3vw,40px);
        ...
        .vpr-testimonial-avatar {
          ...
          background:var(--vpr-surface2); border:1px solid var(--vpr-line2);
          display:flex; align-items:center; justify-content:center;
          font-family:var(--vpr-serif); font-size:20px; font-weight:300; color:var(--vpr-text-muted);
          flex-shrink:0;
        }
        .vpr-testimonial-name { font-size:12px; letter-spacing:0.12em; color:var(--vpr-text); margin-bottom:4px; }
        .vpr-testimonial-role { font-size:10px; letter-spacing:0.14em; color:var(--vpr-text-sub); }
        ...
        .vpr-dot.active { width:40px; background:var(--vpr-accent); }
        ...
        .vpr-price-card {
          ...
          transition:border-color 0.35s, background 0.35s, transform 0.35s var(--vpr-ease);
          position:relative; overflow:hidden;
        }
        .vpr-price-card:hover { border-color:var(--vpr-line2); background:var(--vpr-surface2); transform:translateY(-4px); }
        .vpr-price-card-featured {
          background:color-mix(in srgb, var(--vpr-accent) 9%, var(--vpr-surface));
        ...
        .vpr-price-card-featured::before {
          ...
          background:conic-gradient(from 0deg, var(--vpr-accent), color-mix(in srgb, var(--vpr-accent) 40%, transparent), var(--vpr-accent));
          animation:borderSpin 4s linear infinite;
        }
        @keyframes borderSpin { to { --angle:360deg; } }
        .vpr-price-card-featured::after {
          content:''; position:absolute; inset:2px;
          background:color-mix(in srgb, var(--vpr-accent) 9%, #0D0C11);
          z-index:-1;
        }
        .vpr-price-badge {
          position:absolute; top:24px; right:24px;
          font-size:8px; letter-spacing:0.2em; text-transform:uppercase;
          background:var(--vpr-accent); color:#fff; padding:5px 12px;
        }
        .vpr-price-name { font-size:9px; letter-spacing:0.26em; text-transform:uppercase; color:var(--vpr-accent); margin-bottom:26px; }
        .vpr-price-num { font-family:var(--vpr-serif); font-size:58px; font-weight:300; line-height:1; margin-bottom:24px; color:var(--vpr-text); }
        .vpr-price-desc { font-size:11px; line-height:1.8; color:var(--vpr-text-muted); margin-bottom:36px; letter-spacing:0.04em; }
        .vpr-price-features { list-style:none; display:flex; flex-direction:column; gap:14px; margin-bottom:48px; }
        .vpr-price-features li {
          font-size:11px; color:var(--vpr-text-muted); display:flex; align-items:center;
          gap:14px; letter-spacing:0.04em;
        }
        .vpr-price-features li::before { content:''; width:16px; height:1px; background:var(--vpr-accent); flex-shrink:0; }
        ...
        .vpr-cta-h2 {
          font-family:var(--vpr-serif); font-size:clamp(48px,5vw,84px);
          font-weight:300; line-height:0.94; letter-spacing:-0.012em; color:var(--vpr-text);
        }
        .vpr-cta-aside { display:flex; flex-direction:column; gap:30px; position:relative; z-index:1; }
        .vpr-cta-aside p { font-size:12px; line-height:1.9; color:var(--vpr-text-muted); letter-spacing:0.05em; }
        ...
        .vpr-footer-brand {
          ...
          letter-spacing:0.24em; text-transform:uppercase; color:var(--vpr-text);
          display:block; margin-bottom:18px;
        }
        .vpr-footer-tagline { font-size:10px; line-height:1.7; color:var(--vpr-text-sub); letter-spacing:0.06em; display:block; max-width:280px; }
        ...
        .vpr-footer-social a {
          ...
          font-size:10px; color:var(--vpr-text-sub);
          transition:border-color 0.2s, color 0.2s, background 0.2s;
        }
        .vpr-footer-social a:hover { border-color:var(--vpr-accent); color:var(--vpr-accent); background:color-mix(in srgb, var(--vpr-accent) 8%, transparent); }
        ...
        .vpr-footer-links a {
          font-size:11px; letter-spacing:0.06em; color:var(--vpr-text-sub);
          transition:color 0.2s; display:flex; align-items:center; gap:8px;
        }
        .vpr-footer-links a::before { content:''; width:0; height:1px; background:var(--vpr-accent); transition:width 0.25s var(--vpr-ease); flex-shrink:0; }
        ...
        .vpr-footer-copy { font-size:9px; letter-spacing:0.18em; color:var(--vpr-text-sub); }
        .vpr-footer-legal { display:flex; gap:28px; }
        .vpr-footer-legal a { font-size:9px; letter-spacing:0.14em; color:var(--vpr-text-sub); transition:color 0.2s; }
        .vpr-footer-legal a:hover { color:var(--vpr-text-muted); }
        ...
        .vpr-backtop:hover { border-color:var(--vpr-accent); background:rgba(13,12,17,0.95); }
