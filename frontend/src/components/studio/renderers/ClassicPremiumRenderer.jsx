...
export default function ClassicPremiumRenderer({
  website,
  editing = false,
  selectedId = null,
  onSelect,
  ...
  return (
    <div
      {...editable("site", "site wrapper", undefined, {
        className: `gpr-site gpr-classic-renderer gpr-template-${templateId} gpr-tone-${preset.tone} gpr-mode-${preset.heroMode}`,
        style: {
          "--gpr-primary": primary,
    ...
    >
      ...
      <div className="gpr-renderer-badge">CLASSIC PREMIUM RENDERER</div>

      <style>{`
        .gpr-classic-renderer {
          color: #111827 !important;
          background: #f4efe5 !important;
        }

        .gpr-classic-renderer .gpr-video-overlay {
          background:
            linear-gradient(90deg, rgba(244,239,229,.88), rgba(244,239,229,.62), rgba(20,16,12,.28)) !important;
        }

        .gpr-classic-renderer .gpr-page {
          width: min(1180px, calc(100% - 52px)) !important;
        }

        .gpr-classic-renderer .gpr-hero {
          grid-template-columns: 1fr !important;
          text-align: center !important;
          min-height: 680px !important;
        }

        .gpr-classic-renderer .gpr-hero-copy {
          padding-left: 0 !important;
          margin: 0 auto !important;
        }

        .gpr-classic-renderer .gpr-hero h1,
        .gpr-classic-renderer .gpr-editorial-intro h2,
        .gpr-classic-renderer .gpr-final-cta h2 {
          color: #14110d !important;
          font-family: Georgia, "Times New Roman", serif !important;
        }

        .gpr-classic-renderer .gpr-hero h1 em {
          color: #9a6a30 !important;
        }

        .gpr-classic-renderer .gpr-eyebrow,
        .gpr-classic-renderer .gpr-hero-subtitle,
        .gpr-classic-renderer .gpr-nav-links,
        .gpr-classic-renderer .gpr-footer {
          color: rgba(20,17,13,.7) !important;
        }

        .gpr-classic-renderer .gpr-feature-strip,
        .gpr-classic-renderer .gpr-stat-card,
        .gpr-classic-renderer .gpr-mosaic-story,
        .gpr-classic-renderer .gpr-mosaic-video,
        .gpr-classic-renderer .gpr-mini-feature,
        .gpr-classic-renderer .gpr-featured-visual,
        .gpr-classic-renderer .gpr-editorial-card,
        .gpr-classic-renderer .gpr-final-cta {
          background: rgba(255,255,255,.68) !important;
          border-color: rgba(20,17,13,.12) !important;
          color: #14110d !important;
          box-shadow: 0 24px 70px rgba(70,50,30,.16) !important;
        }

        .gpr-classic-renderer .gpr-hero-side {
          justify-content: center !important;
          min-height: auto !important;
        }

        .gpr-classic-renderer .gpr-hero-stats {
          margin-top: 34px !important;
        }

        .gpr-classic-renderer .gpr-mosaic {
        ...
        .gpr-classic-renderer .gpr-mosaic-stack {
          grid-column: span 2 !important;
          grid-template-columns: 1fr 1fr !important;
          grid-template-rows: auto !important;
        }

        .gpr-classic-renderer .gpr-gallery-grid {
